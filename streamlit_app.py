...
L1 = 100
L2 = st.slider("Height of first bar (should be the highest) = ", min_value=1, max_value=100, value = 75)
L3 = st.slider("Height of second bar = ", min_value=1, max_value=100, value= 50)
L4 = st.slider("Height of third bar = ", min_value=1, max_value=100, value = 25)
L10 = 1
